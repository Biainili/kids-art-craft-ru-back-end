    ...
    bot.sendMessage(
      ...
      `${
        language === "am"
          ...
          \n<b>🪪 Ստացող: <code>Armen Barkhudaryan</code></b>\n\n\n<i>🔻Վճարումից հետո, խնդրում ենք այս չատում ուղարկել հաղորդագրություն, որը պարունակում է՝</i> <b>🧾 վճարման չեկը -կամ- 👤 վճարողի անունը և ազգանունը</b>`
      ...
      \n<b>🪪 Получатель: <code>Armen Barkhudaryan</code></b>\n\n\n<i>🔻После оплаты, пожалуйста, отправьте в этот чат сообщение, содержащее։ <b>🧾 чек оплаты -или- 👤  имя и фамилию плательщика</b>.`
      }      
      `,
      {
