...
<br><b>Պատվերի պատրաստման ժամանակ:</b><br>
...
<br>Եթե ունեք հավելյալ հարցեր, կարող եք կապ հաստատել մեզ հետ Telegram-ի միջոցով։
        `,
      { parse_mode: "HTML" }
    );
  }
    ...
    bot.sendMessage(
      ...
      `${
        language === "am"
          ...
          \n<b>🪪 Ստացող: <code>Armen Barkhudaryan</code></b>\n\n\n<i>🔻Վճարումից հետո, խնդրում ենք այս չատում ուղարկել հաղորդագրություն, որը պարունակում է՝</i>\n <b> - 🧾 վճարման չեկը </b>կամ<b>   👤 վճարողի անունը և ազգանունը</b>`
      ...
      \n<b>🪪 Получатель: <code>Armen Barkhudaryan</code></b>\n\n\n<i>🔻После оплаты, пожалуйста, отправьте в этот чат сообщение, содержащее։\n <b> - 🧾 чек оплаты </b>или<b>   👤  имя и фамилию плательщика</b>.`
      }      
      `,
      {
...
bot.on("callback_query", (callbackQuery) => {
  ...
  if (callbackData.startsWith("approve_") && order) {
    ...
    bot.sendMessage(
      ...
      🗣 ${
        language === "am"
          ? `Ստացեք 10% զեղչ այս պրոմոկոդով`
          : `Получите 10% скидку по этому промокоду`
      } <b>--- <code>KIDS2024</code></b>`,
      { parse_mode: "HTML" }
    );
